...
var About = React.createClass({
  ...
  render() {
    ...
    return (
      <div>
        <h1 className="page-header">About Slowpost</h1>
        <h2>SAY SOMETHING MEANINGFUL</h2>
        <p> Slowpost enables meaningful, modern communication between friends and family. Choose a person to write to, add a photo, compose your message, and then send it! Your Post will be delivered to your friends phone 1 to 2 days after being sent. Enjoy the deeper form of communication that happens when people stop chatting and start saying something meaningful to each other.</p>
